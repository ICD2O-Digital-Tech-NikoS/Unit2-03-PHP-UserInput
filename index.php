...
<html lang="en-ca">
  ...
  <body>
    ...
    <form action="./welcome.php" method="post" target="result">
      ...
      <input type="number" id="streetnumber" placeholder="Street Number" name="streetnumber""><br><br>
      <label for="streetname"">Street Name</label>
      <input type="text" id="streetname" placeholder="Street Name" name="streetname"><br><br>
